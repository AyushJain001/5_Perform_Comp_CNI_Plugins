...
## Additional Explanatory Plots (Hardcoded)

These optional hardcoded matplotlib plots help explain results clearly to non-experts in demo/viva.

Generate:

```bash
cd /home/iiitd/grs
/home/iiitd/grs/G_5_artifacts/G_5_venv/bin/python G_5_plots/G_5_plot_throughput_ratio_hardcoded.py
/home/iiitd/grs/G_5_artifacts/G_5_venv/bin/python G_5_plots/G_5_plot_latency_variability_hardcoded.py
```

Files:

- `G_5_plots/G_5_plot_throughput_ratio_hardcoded.py`
- `G_5_plots/G_5_plot_latency_variability_hardcoded.py`
- `G_5_plots/G_5_throughput_ratio.png`
- `G_5_plots/G_5_latency_variability.png`

Suggested narrative in report/demo:

1. Throughput achievement plot shows all CNIs sustain almost 100% of target QPS.
2. Variability plot shows mean p99 plus min/max spread across 5 runs per QPS (stability insight).
